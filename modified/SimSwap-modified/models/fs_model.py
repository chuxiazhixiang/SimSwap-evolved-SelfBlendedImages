...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        #做了修改，默认device就是cuda，这样用不了cuda的完蛋了
        ...
        netArc_checkpoint = torch.load(netArc_checkpoint, map_location=torch.device("cpu"),weights_only=False) #不加后面那个weights_only的话，cpu运行有问题
